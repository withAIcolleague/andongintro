...
richSections: [
  {
    ...
    paragraphs: [
      ...
      '세 번째 문단. 이동, 시간대, 체류 방식처럼 실제 방문 판단에 필요한 맥락을 덧붙인다.'
    ]
  },
  {
    eyebrow: 'WALK NOTE',
    ...
    paragraphs: [
      ...
      '방문자가 현장에서 선택을 바꿀 수 있도록 대안 동선이나 줄일 수 있는 범위를 적는다.'
    ]
  },
  {
    eyebrow: 'DETAIL',
    ...
    paragraphs: [
      ...
      '사진에 보이는 장면과 본문에서 설명하는 이야기가 어떻게 연결되는지 쓴다.',
      '처음 보는 사람도 이해할 수 있도록 어려운 고유명사는 짧게 풀어 쓴다.'
    ]
  },
  {
    eyebrow: 'VISIT NOTE',
    ...
    paragraphs: [
      ...
      '계절, 날씨, 교통, 예약처럼 바뀔 수 있는 요소는 확인 필요 지점을 분명히 남긴다.',
      '마지막 문단은 다음 장소나 관련 코스로 자연스럽게 이어질 수 있게 작성한다.'
    ]
  }
]
```
...
- `paragraphs`는 최소 3개를 작성한다. 각 문단은 한두 줄 메모가 아니라 방문자가 장면을 상상하고 실제 방문 방식을 판단할 수 있을 만큼 구체적으로 쓴다.
