...
| 이미지 | 사용 콘텐츠 수 | 우선 판단 |
|---|---:|---|
| `assets/wolyeonggyo.jpg` | 18 | 전용 이미지 대체 우선 |
| `assets/hanokmaul.jpg` | 16 | 전용 이미지 대체 우선 |
| `assets/jjimdak.png` | 13 | 전용 이미지 대체 우선 |
...
| 이미지 | 사용 콘텐츠 수 | 사용 콘텐츠 |
|---|---:|---|
| `assets/wolyeonggyo.jpg` | 18 | `food:jjimdak`, `food:soju`, `food:mackerel`, `event:maskdance`, `event:cherry`, `event:waterfesta`, `event:ice`, `place:wolyeonggyo`, `place:byeongsan`, `place:bongjeongsa`, `place:market-place`, `place:imcheonggak`, `place:andongdam`, `course:first-day`, `course:food-course`, `course:night-course`, `course:transit-course`, `course:car-course` |
| `assets/hanokmaul.jpg` | 16 | `food:soju`, `food:heotjesabap`, `food:guksi`, `food:mackerel`, `food:octopus`, `food:jongga`, `event:ice`, `place:hahoe`, `place:wolyeonggyo`, `place:dosan`, `place:byeongsan`, `place:yekki`, `place:susanggil`, `place:imcheonggak`, `course:history-course`, `course:family-course` |
| `assets/jjimdak.png` | 13 | `food:jjimdak`, `food:soju`, `food:guksi`, `food:octopus`, `food:market`, `event:maskdance`, `place:market-place`, `course:first-day`, `course:food-course`, `course:festival-course`, `course:night-course`, `course:family-course`, `course:transit-course` |
