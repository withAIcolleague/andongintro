...
| `assets/hanokmaul.jpg` | 11 | 전용 이미지 대체 우선 |
...
| `assets/andong-moonlight-dzrsh.png` | 6 | 보조 이미지 분산 검토 |
...
| `assets/hanokmaul.jpg` | 11 | `food:heotjesabap`, `food:mackerel`, `food:octopus`, `food:jongga`, `place:hahoe`, `place:wolyeonggyo`, `place:dosan`, `place:yekki`, `place:susanggil`, `course:history-course`, `course:family-course` |
...
| `assets/andong-moonlight-dzrsh.png` | 6 | `food:market`, `event:maskdance`, `event:moonlight`, `place:wolyeonggyo`, `course:festival-course`, `course:night-course` |
