...
| `place:market-place` | 안동구시장 | `assets/andong_gusijang_arcade.png` | 4 |
...
| 이미지 | 사용 콘텐츠 수 | 우선 판단 |
|---|---:|---|
| `assets/wolyeonggyo.jpg` | 13 | 전용 이미지 대체 우선 |
| `assets/hanokmaul.jpg` | 9 | 보조 이미지 분산 검토 |
| `assets/jjimdak.png` | 9 | 보조 이미지 분산 검토 |
| `assets/hero_hahoe.png` | 8 | 보조 이미지 분산 검토 |
| `assets/seowon.png` | 8 | 보조 이미지 분산 검토 |
| `assets/heotjesabap.png` | 7 | 보조 이미지 분산 검토 |
...
| 이미지 | 사용 콘텐츠 수 | 사용 콘텐츠 |
|---|---:|---|
| `assets/wolyeonggyo.jpg` | 13 | `food:jjimdak`, `food:mackerel`, `event:maskdance`, `event:cherry`, `place:wolyeonggyo`, `place:byeongsan`, `place:bongjeongsa`, `place:andongdam`, `course:first-day`, `course:food-course`, `course:night-course`, `course:transit-course`, `course:car-course` |
...
| `assets/jjimdak.png` | 9 | `food:jjimdak`, `food:market`, `event:maskdance`, `course:first-day`, `course:food-course`, `course:festival-course`, `course:night-course`, `course:family-course`, `course:transit-course` |
...
| `assets/heotjesabap.png` | 7 | `food:jjimdak`, `food:soju`, `food:heotjesabap`, `food:guksi`, `food:mackerel`, `food:jongga`, `course:food-course` |
...
| `assets/andong_market.png` | 4 | `food:jjimdak`, `food:octopus`, `food:market`, `place:market-place` |
...
| `assets/soju.png` | 3 | `food:soju`, `food:heotjesabap`, `course:food-course` |
| `assets/sunsungmemory.jpg` | 3 | `place:yekki`, `place:susanggil`, `place:andongdam` |
| `assets/andong_market_food_alley.png` | 2 | `food:market`, `place:market-place` |
...
| `assets/andong_gusijang_arcade.png` | 1 | `place:market-place` |
| `assets/andong_gusijang_walkway.png` | 1 | `place:market-place` |
